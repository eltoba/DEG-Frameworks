 ...
 */
class mod_plantilla extends PDO_class {
...
// creamos el array1
        ...
        return (array)$dato = array_merge($plantillas, $contenido); // lo que hace es sobrescribir la plantilla de contenido ensima de la de plantillas y lo que causa es reemplazar "sec_contenido"=>"inicio" por "sec_contenido"=>"la ruta de la seccion que se quiere cargar"
    }
}
