<!-- Content (Right Column) -->
    <div id="content" class="box">
      <div id="menu" class="box">
        <ul class="box">
          <li><a href="index.php?ir=razas&pag=1"><span>{listar}</span></a></li>
          <li><a href="index.php?ir=insertar_raza"><span>{insertar}</span></a></li>
          <li><a href="index.php?ir=eliminar_raza"><span>{eliminar}</span></a></li>
          <li><a href="index.php?ir=infomod&mod=razas"><span>{infoversion}</span></a></li>
        </ul>
      </div>
<!-- Table (TABLE) -->
      ...
      <fieldset>
      <form action="index.php?ir=insertar_raza" method="post">
        <table class="nostyle">
          <tr>
            <td>{form_id}</td>
            <td>{id}</td>
          ...
          <tr>
            <td>{form_nombre}</td>
            <td><input type="text" size="40" name="nombre" value="{nombre}" id="nombre" class="input-text" /> - {nombre}</td>
          </tr>
          <tr>
            <td>{form_hp}</td>
